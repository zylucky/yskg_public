		      ...
		      fx_send(){
		      	wx.ready(()=>{
					wx.onMenuShareAppMessage({
					    ...
					    link: 'http://47.92.6.78/yskg_public/#/?hourse_id=' + this.hourse_id,
					    imgUrl: 'http://47.92.6.78:81/yskjapp/shi_ion.png', // 分享图标
					...
					wx.onMenuShareTimeline({
					    title: this.topic + '  ' + this.zdh +'  '+ this.fybh, // 分享标题
					    link: 'http://47.92.6.78/yskg_public/#/?hourse_id=' + this.hourse_id, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
					    imgUrl: 'http://47.92.6.78:81/yskjapp/shi_ion.png', // 分享图标
					    success: function () { 
